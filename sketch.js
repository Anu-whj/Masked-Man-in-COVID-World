...
function draw() {
  ...
  //adjusting masked man's depth when he comes near fruits basket    
   if((maskman.x > 410) && (maskman.x<542) && (maskman.y < 168))
  {
    maskman.velocityY=0; 
 ...
 if((maskman.x - basket1.x < 93) && (maskman.y<114))
 {
  ...
  {  
    ...
    circle(300, 100, 300);
    fill("blue");
    text("GAME OVER!!! Press 'R' to restart",200,70);
    text("The Masked Man failed to maintain his immunity and crossed the maximum risk factor.",200,90,210, 300);  
    maskman.velocityX = 0;
    maskman.velocityY =0;
    if(keyDown("r"))
    {
